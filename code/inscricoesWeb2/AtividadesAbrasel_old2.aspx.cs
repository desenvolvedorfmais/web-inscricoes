...
public partial class AtividadesAbrasel_old2 : System.Web.UI.Page
{
    ...
    */
    ...
    protected void F_001606027_CheckedChanged(object sender, EventArgs e)
    {
        if (F_001606027.Checked)
        {
            ...
            if ((M_001606054.Checked) || (M_001606055.Checked) || (M_001606056.Checked) || (M_001606057.Checked) || (M_001606058.Checked) || (M_001606059.Checked))
            {
                string txt = "";
