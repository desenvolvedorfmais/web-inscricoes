<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="frmDadosHospedagemExpoepi.aspx.cs" Inherits="frmDadosHospedagemExpoepi" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnVoltar" runat="server" OnClick="btnVoltar_Click" Text="Voltar" 
            BackColor="Red" CssClass="botoes" ForeColor="White" 
    ...
    <asp:Button ID="btnImprimir" runat="server" OnClick="btnImprimir_Click" Text="Imprimir" 
            BackColor="Red" CssClass="botoes" ForeColor="White" Width="94px" 
            Visible="False" />
        <br />
        <br />
