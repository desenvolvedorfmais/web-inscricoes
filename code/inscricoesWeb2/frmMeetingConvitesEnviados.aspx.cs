...
public partial class frmMeetingConvitesEnviados : System.Web.UI.Page
{
    ...
    protected void verificarIdioma(string prmIdioma)
    {
        if (prmIdioma == "PTBR")
        {
            ...
            lblTituloPagina.Text = "Convites Enviados";
            ...
            btnNovoConvite.Text = "Novo Convite";
        ...
        else if (prmIdioma == "ENUS")
        {
            ...
            lblTituloPagina.Text = "Invitations Sent";
            ...
            btnNovoConvite.Text = "New Invite";
    ...
    protected void ListarConvites()
    {
        ...
        oDT = oMeetingConviteCad.ListarEnviados(SessionEvento.CdEvento, SessionParticipante.CdParticipante, SessionCnn);
    ...
    protected string filtros()
    {
        ...
        if (txtEmpresaFiltro.Text.Trim() != "")
            retorno = "noInstituicaoParticipanteConvidado like '%" + txtEmpresaFiltro.Text + "%' ";

        if (txtPaisFiltro.Text.Trim() != "")
        {
            if (retorno == "")
                retorno = "noPaisParticipanteConvidado like '%" + txtPaisFiltro.Text + "%' ";
            else
                retorno += " and noPaisParticipanteConvidado like '%" + txtPaisFiltro.Text + "%' ";
        }

        if (txtAreaAtuacaoFiltro.Text.Trim() != "")
        {
            if (retorno == "")
                retorno = "noAreaAtuacaoParticipanteConvidado like '%" + txtAreaAtuacaoFiltro.Text + "%' ";
            else
                retorno += " and noAreaAtuacaoParticipanteConvidado like '%" + txtAreaAtuacaoFiltro.Text + "%' ";
        }
    ...
    protected void grd_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            btndetalhe.PostBackUrl = "~/frmMeetingConviteEnv.aspx?cdConviteEnv=" + lblCdConvite.Text;
