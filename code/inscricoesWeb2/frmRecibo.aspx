<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="frmRecibo.aspx.cs" Inherits="frmRecibo" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Button ID="btnImprimirBoleto" runat="server" OnClick="btnImprimir_Click" Text="Imprimir" 
