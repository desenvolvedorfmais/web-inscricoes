...
public partial class frmEnunciadosLista : System.Web.UI.Page
{
    ...
    protected void verificarIdioma(string prmIdioma)
    {
        ...
        if (prmIdioma == "PTBR")
        {
            ...
            lblTituloPagina.Text = "Enunciados";
            ...
            lblTxtInstrucao.Text = @"
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'><strong>DA SUBMISS&Atilde;O DE ENUNCIADOS E PAUTAS PARA GRUPOS DE TRABALHO</strong></p>
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'>&nbsp;</p>
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'>Qualquer participante do segundo dia do evento poder&aacute; enviar at&eacute; o dia 26 de setembro de 2017 enunciados com indica&ccedil;&atilde;o de um dos temas dos 06 grupos de trabalho com uma breve justificativa.</p>
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'>&nbsp;</p>
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'>Ficar&aacute; a crit&eacute;rio do coordenador aceitar e levar &agrave; discuss&atilde;o no grupo os enunciados apresentados que n&atilde;o atendam ao modelo pr&eacute;-estabelecido, assegurando-se, dessa forma, sugerir a modifica&ccedil;&atilde;o do teor do enunciado para que atenda ao modelo do evento.</p>
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'>&nbsp;</p>
<p style='margin: 0cm 0cm 8pt 18pt; line-height: 107%; font-size: 11pt; font-family: Calibri, sans-serif;'>O participante que apresentar enunciados para mais de 01 tema dos Grupos de Trabalho ser&aacute; sorteado para participar de somente de 01 (um) dos Grupos.</p>
";

            btnNovo.Text = "Cadastrar Novo Enunciado";            
    ...
    protected void PesquisarTeses()
    {
        ...
        oDT = oParticipanteDocEnviadoCad.Listar(SessionParticipante.CdEvento, SessionParticipante.CdParticipante, SessionCnn);
    ...
    protected void grdTeses_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            if (SessionIdioma == "PTBR")
            {
                ...
                e.Row.Cells[1].Text = "Tema";
                e.Row.Cells[2].Text = "Título";
                e.Row.Cells[3].Text = "Situação";
            }
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[0].Attributes.Add("onclick", "window.open('frmEnviarDocumento3.aspx?cdDoc=" + e.Row.Cells[0].Text + "','_self');");
            e.Row.Cells[1].Attributes.Add("onclick", "window.open('frmEnviarDocumento3.aspx?cdDoc=" + e.Row.Cells[0].Text + "','_self');");
            e.Row.Cells[2].Attributes.Add("onclick", "window.open('frmEnviarDocumento3.aspx?cdDoc=" + e.Row.Cells[0].Text + "','_self');");
            e.Row.Cells[3].Attributes.Add("onclick", "window.open('frmEnviarDocumento3.aspx?cdDoc=" + e.Row.Cells[0].Text + "','_self');");
            e.Row.Cells[4].Attributes.Add("onclick", "window.open('frmEnviarDocumento3.aspx?cdDoc=" + e.Row.Cells[0].Text + "','_self');");
            //e.Row.Cells[5].Attributes.Add("onclick", "window.open('frmEnviarDocumento3.aspx?cdTese=" + e.Row.Cells[0].Text + "','_self');");
    ...
    protected void btnNovo_Click(object sender, EventArgs e)
    {
        ...
        Session["SessionParticipanteDocEnviado"] = null;

        //Server.Transfer("frmCadastrarTrabalhosTecnicos.aspx", false);
        Response.Write("<script>window.open('frmEnviarDocumento3.aspx?cdDoc=','_self');</script>");
    }
}