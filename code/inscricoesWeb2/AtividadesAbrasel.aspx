<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AtividadesAbrasel.aspx.cs" Inherits="AtividadesAbrasel" title="Inscri&ccedil;&otilde;es Web" %>
            ...
            <asp:TabPanel ID="Mesa" runat="server" HeaderText="Aulas Show" Visible="false">
                <ContentTemplate><br />
                    ...
                    <div id="d12_M" runat="server" class="Abrsel_dia13"><br />
                        ...
                        <asp:CheckBox ID="M_001606032" runat="server" 
                          ...
                          <asp:CheckBox ID="M_001606046" runat="server" 
                            Text="&lt;b&gt; Dia 13/08 (12:00 a 12:45 - MÃO NA MASSA)  &lt;font color='navy'&gt;- Pedro Liberalesso&lt;/font&gt;&lt;/b&gt;" 
                            AutoPostBack="True" oncheckedchanged="F_001606019_CheckedChanged" /><br /><br />
                        ...
                        <asp:CheckBox ID="M_001606034" runat="server" 
                          ...
                          <asp:CheckBox ID="M_001606033" runat="server" 
                            ...
                            Text="&lt;b&gt; Dia 13/08 (13:00 a 13:45 - CONFEITARIA/PADARIA)  &lt;font color='navy'&gt;- Daniel Briand&lt;/font&gt;&lt;/b&gt;" 
                            AutoPostBack="True" oncheckedchanged="F_001606019_CheckedChanged" /><br /><br />
                    ...
                    <div id="d13_M" runat="server" class="Abrsel_dia14"><br />
                        ...
                        <asp:CheckBox ID="M_001606079" runat="server" 
                        ...
                        <asp:CheckBox ID="M_001606080" runat="server"                         
                            
                                Text="&lt;b&gt; Dia 18/08 (14:00 a 14:45 - SALA DE DEGUSTAÇÃO) &lt;font color='navy'&gt;- Topema&lt;/font&gt;&lt;/b&gt;" 
                                AutoPostBack="True" oncheckedchanged="F_001606019_CheckedChanged" /><br /><br />
