<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmMeetingParticipantes.aspx.cs" Inherits="frmMeetingParticipantes" title="Inscri&ccedil;&otilde;es Web"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h3>
        <asp:Label ID="lblTituloPagina" runat="server" Text="Convidar Participantes" CssClass="titulo"></asp:Label>
        <br />
    </h3>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <div id="divBtnMeeting" class="clsBtnMeeting">                                    
                                    <asp:Label ID="lblCdParticipante" runat="server" Visible="False" Text='<%# Eval("cdParticipante") %>'></asp:Label>
                                    <asp:Button ID="btnMaisInf" CssClass="botoes" runat="server" Text="Convidar"></asp:Button>
                                    &nbsp;&nbsp;
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="cdParticipante" HeaderText="Convite" Visible="False">
