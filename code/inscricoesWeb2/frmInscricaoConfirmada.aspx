<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="frmInscricaoConfirmada.aspx.cs" Inherits="frmInscricaoConfirmada" title="Inscri&ccedil;&otilde;es Web" %>
...
<div id="frmCad_auto">
    <h3>
        <br/><br>
            <asp:Label ID="lblTitulo" runat="server" Text="Confirmação de Inscrição" CssClass="titulo"></asp:Label>
        <br/><br/><br>
    </h3>
    ...
    <asp:Button ID="Button2" runat="server" Text="Ok" 
             UseSubmitBehavior="False" CssClass="botoes" /></div>
            <br />            
            <div id="telacad_info">
