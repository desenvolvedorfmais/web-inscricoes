<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmMeetingConvitesEnviados.aspx.cs" Inherits="frmMeetingConvitesEnviados" title="Inscri&ccedil;&otilde;es Web"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h3>
        <asp:Label ID="lblTituloPagina" runat="server" Text="Convites Enviados" CssClass="titulo"></asp:Label>
        <br />
    </h3>
            ...
            <ContentTemplate> 
                <div id="filtroMeeting" class="clsFiltroMeeting">
                    ...
                    <div class="clsBtnMeeting">                                    
                        ...
                        <asp:Button ID="btnNovoConvite" CssClass="botoes" runat="server" Text="Novo Convite" OnClick="btnNovoConvite_Click" PostBackUrl="~/frmMeetingParticipantes.aspx"></asp:Button>
                        &nbsp;&nbsp;
                    </div>
                </div>
                ...
                <asp:GridView ID="grdConvites" runat="server" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" GridLines="None" OnRowDataBound="grd_RowDataBound" Width="100%">
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <div id="divEmpresaMeeting" class="clsEmpresaMeeting">
                                    ...
                                    <asp:Label ID="lblEmpresa" runat="server" Font-Bold="True" Text='<%# Eval("noInstituicaoParticipanteConvidado") %>'></asp:Label>
                                </div>
                                <div id="divPaisMeeting" class="clsEmpresaMeeting">
                                    <asp:Label ID="Pais" runat="server" Text="País:"></asp:Label>
                                    <asp:Label ID="lblPais" runat="server" Font-Bold="True" Text='<%# Eval("noPaisParticipanteConvidado") %>'></asp:Label>
                                </div>
                                <div id="divAreaAtuacaoMeeting" class="clsAreaAtuacaoMeeting">
                                    ...
                                    <asp:Label ID="lblAreaAtuacao" runat="server" Font-Bold="True" Text='<%# Eval("noAreaAtuacaoParticipanteConvidado") %>'></asp:Label>
                                    &nbsp;&nbsp;
                                </div>
                                <div id="divRepresentanteMeeting" class="clsRepresentanteMeeting">
                                    ...
                                    <asp:Label ID="lblRepresentante" runat="server" Font-Bold="True" Text='<%# Eval("noParticipanteConvidado") %>'></asp:Label>
                                </div>
                        ...
                        <asp:BoundField DataField="noInstituicaoParticipanteConvidado" HeaderText="Empresa" Visible="False">
                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="75px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="noPaisParticipanteConvidado" HeaderText="País" Visible="False" />
                        <asp:BoundField DataField="noAreaAtuacaoParticipanteConvidado" HeaderText="Área de Atuação" Visible="False">
                        ...
                        <asp:BoundField DataField="noParticipanteConvidado" HeaderText="Representante" Visible="False">
