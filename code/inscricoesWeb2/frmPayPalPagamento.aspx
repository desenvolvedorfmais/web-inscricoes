<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmPayPalPagamento.aspx.cs" Inherits="frmPayPalPagamento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="frmCad_auto">
        ...
        <br />
        <br />
        <asp:Panel ID="p1" CssClass="" runat="server">
            <center><div><asp:Image ID="Image1" runat="server" ImageUrl="~/img/paypal-logo.png" /></div></center>
            <br />
            <br />
            ...
            <br />
            &nbsp;&nbsp;
            <asp:Button ID="btnContinuarPayPal" runat="server" CssClass="botoes" 
