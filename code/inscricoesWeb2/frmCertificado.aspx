<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="frmCertificado.aspx.cs" Inherits="frmCertificado" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnVoltar" runat="server" OnClick="btnVoltar_Click" Text="Voltar" 
            ...
            PostBackUrl="~/frmListarPedidos.aspx" Width="94px" Visible="False" />
    <asp:Button ID="btnImprimir" runat="server" OnClick="btnImprimir_Click" Text="Imprimir" 
       ...
       <%-- <cc1:StiWebViewer ID="StiWebViewer1" runat="server"
            ...
            PrintDestination="Direct" Visible="False" />--%>
        <br />
        <cc2:StiWebViewerFx ID="StiWebViewerFx1" runat="server" Height="100%" Width="100%" OnReportExport="StiWebViewerFx1_ReportExport" Visible="False" />
        &nbsp;</div>
</form>
</body>
</html>
