...
public partial class frmRecibo : System.Web.UI.Page 
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (SessionEvento.CdEvento == "005503")
        {
            if (SessionPedido.NuCPFCNPJRecibo.Length == 11)
                caminho = caminho + "\\relatorios\\rptReciboNTUPF.mrt";
            else
                caminho = caminho + "\\relatorios\\rptReciboNTUPJ.mrt";
        }
        else
