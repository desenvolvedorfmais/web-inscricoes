...
public partial class frmMeetingParticipantes : System.Web.UI.Page
{
    ...
    protected void verificarIdioma(string prmIdioma)
    {
        if (prmIdioma == "PTBR")
        {
            ...
            lblTituloPagina.Text = "Convidar Participantes";
        ...
        else if (prmIdioma == "ENUS")
        {
            ...
            lblTituloPagina.Text = "Invite Participants";
    ...
    protected void ListarParticpantesMeeting()
    {
        ...
        oDT = oMeetingParticipanteCad.Listar(SessionEvento.CdEvento, SessionParticipante.CdParticipante, SessionCnn);
        ...
        oDT.DefaultView.Sort = "noInstituicao";
    ...
    protected void grd_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Label lblCdParticipante = (Label)e.Row.FindControl("lblCdParticipante");
            
                       

            Button btndetalhe = (Button)e.Row.FindControl("btnMaisInf");
            btndetalhe.PostBackUrl = "~/frmMeetingConviteEnv.aspx?cdPartConv=" + lblCdParticipante.Text;
