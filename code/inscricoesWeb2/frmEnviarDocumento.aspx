<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmEnviarDocumento.aspx.cs" Inherits="frmEnviarDocumento" 
                ...
                <table  id="Table2"  border="0" cellpadding="0" cellspacing="10" width="100%" runat="server"> 
                    ...
                    <tr id="linhaArquivo" runat="server" visible="true">
                        <td align="left" >
                            ...
                            <asp:Button ID="btnEnviarDocumento0" runat="server" CssClass="botoes" OnClick="btnEnviarDocumento0_Click" TabIndex="32" Text="Enviar Depois" />
