...
public partial class frmEnviarDocumento : System.Web.UI.Page
{
    ...
    protected void verificarIdioma(string prmIdioma)
    {
        if (prmIdioma == "PTBR")
        {
            ...
            btnEnviarDocumento0.Text = "Enviar Depois";
    ...
    protected string enviarArquivo(Participante prmParticipante)
    {
        ...
        if (FileUpload1.HasFile)
        {
            try
            {
                ...
                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".odt");//word do brOffice
                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".doc");
                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".rtf");
                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".docx");

                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".pdf");

                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".odp");//power point do brOffice
                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".ppt");
                File.Delete(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + ".pptx");

                FileUpload1.SaveAs(caminho + "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + extension);

                string tmpDsNomeArquivo = "doc_" + prmParticipante.CdParticipante + "_001" + "_CPF_" + prmParticipante.NuCPFCNPJ + "_" + prmParticipante.NoParticipante + extension;
