...
public partial class frmBuscaCPF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            {             
                ...
                //por causa do evento '008701' abimde
                Response.Redirect("http://fazendomais4.azurewebsites.net/inscr.aspx?codEvento=MDA4NzAx&cdLng=PTBR&cat=00870101&atv=&keyAut=&tpSist=NRM&tpAcesso=NRM");
            }
