<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmSipagRetorno.aspx.cs" Inherits="frmSipagRetorno" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h3>
                                ...
                                <div id="vlr_item_pedido" class="valor_item_pedido">
                                    <asp:Panel ID="pnlResumoVlrItens" runat="server">
                                        ...
                                        <div id="vlrItem" class="clsVlrItem" runat="server">
                                            ...
                                            <br />
                                            <asp:Label ID="lblVlAtividade" runat="server" Text='<%# Eval("vlAtividade") %>' ></asp:Label>
                                        </div>                                                                                                                                
                                        ...
                                        <div id="vlrQtdItem" class="clsVlrQtdItem" runat="server">
                                            ...
                                            <br />
                                            (&nbsp;x&nbsp;)
                                            <asp:Label ID="lblVlQuantidade" runat="server" Text='<%# Eval("vlQuantidade") %>' Visible="True"></asp:Label>
                                        </div>
        ...
        <div id="resumo_carrinho2">
            ...
            <asp:Button ID="btnOk" runat="server" Text="Ok" Visible="False" Width="96px" CssClass="botoes" PostBackUrl="~/frmCadastroAuto.aspx" />
